...
// Updated GTFS-RT feed endpoint for Translink Queensland.
// Replace this with the correct endpoint if it differs.
const FEED_URL = "https://gtfs.translink.com.au/v2/gtfsrealtime";
// Target stop ID for Northshore Hamilton
...
function loadAndProcessFeed() {
  ...
  protobuf.load("gtfs-realtime.proto", function(err, root) {
    ...
    // Fetch the binary feed from the updated endpoint
    fetch(FEED_URL)
      .then(response => {
